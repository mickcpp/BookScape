...
(3018, 'Dark Horse', 'Compact Disc', 11.99, 'productImages/musics/CD KatyPerry.jpg', 140, 'Pop', 'CD', 2022, 13, 'Katy Perry'),
...
(3023, 'OK Computer', 'Vinile 33 giri', 22.99, 'productImages/musics/Vinile Radiohead.jpg', 100, 'Rock', 'Vinile', 2023, 12, 'Radiohead'),
...
(3026, 'Jagged Little Pill', 'Compact Disc', 16.99, 'productImages/musics/CD Alanis.jpg', 120, 'Rock', 'CD', 2022, 13, 'Alanis Morissette'),
...
('Lampada USB astronauta', 'Lampada da scrivania in stile astronauta, alimentata tramite USB', 12.99, 80, 'Plastica', 'productImages/gadgets/lampada usb astronauta.jpg', 10.0, 6.0, 15.0),
('Felpa con cappuccio Hogwarts', 'Felpa con cappuccio ispirata ad Hogwarts, dalla serie di libri Harry Potter', 29.99, 120, 'Cotone', 'productImages/gadgets/felpa hogwarts.jpg', 0, 0, 0),
('Puzzle Rubik Cube', 'Puzzle classico Rubik Cube da risolvere', 8.99, 100, 'Plastica', 'productImages/gadgets/puzzle rubiks cube.jpg', 5.7, 5.7, 5.7),
('Portachiavi Pac-Man', 'Portachiavi a forma di Pac-Man, con suoni originali del gioco', 5.99, 150, 'Plastica', 'productImages/gadgets/portachiavi pacman.jpg', 6.0, 4.0, 1.5),
('Cuscino emoji', 'Cuscino a forma di emoji, perfetto per decorare il tuo divano', 11.99, 90, 'Tessuto microfibra', 'productImages/gadgets/cuscino emoji.jpg', 30.0, 30.0, 0),
('Action Figure Iron Man', 'Action figure di Iron Man, personaggio dei fumetti Marvel', 18.99, 80, 'Plastica', 'productImages/gadgets/action figure ironman.jpg', 0, 0, 0),
('Cover per cellulare Game Boy', 'Cover per cellulare ispirata alla console Game Boy', 6.99, 200, 'Plastica rigida', 'productImages/gadgets/cover gameboy.jpg', 0, 0, 0),
('Sciarpa TARDIS Doctor Who', 'Sciarpa ispirata alla TARDIS, dalla serie TV Doctor Who', 14.99, 120, 'Lana', 'productImages/gadgets/sciarpa tardis.jpg', 180.0, 0, 0),
('Lampada da scrivania USB flessibile', 'Lampada da scrivania flessibile, alimentata tramite USB', 9.99, 150, 'Plastica', 'productImages/gadgets/lampada flessibile usb.jpg', 25.0, 0, 0),
('Cuffie bluetooth', 'Cuffie bluetooth leggere e compatte, con alta qualità audio', 24.99, 100, 'Plastica', 'productImages/gadgets/cuffie bluetooth.jpg', 0, 0, 0),
('Action Figure Spider-Man', 'Action figure di Spider-Man, personaggio dei fumetti Marvel', 16.99, 80, 'Plastica', 'productImages/gadgets/action figure spiderman.jpg', 0, 0, 0),
('Poster cinematografico vintage', 'Poster vintage di film classici, perfetti per decorare le pareti', 7.99, 120, 'Carta', 'productImages/gadgets/poster vintage.jpg', 30.0, 45.0, 0),
('Luce notturna Luna 3D', 'Luce notturna a forma di Luna 3D, con effetto realistico', 19.99, 90, 'Plastica', 'productImages/gadgets/luce notturna luna.jpg', 15.0, 0, 0),
('Portaoggetti da scrivania in legno', 'Portaoggetti da scrivania in legno con scomparti multipli per organizzare gli oggetti', 13.99, 100, 'Legno', 'productImages/gadgets/portaoggetti legno.jpg', 20.0, 10.0, 8.0),
('Cover per laptop Starry Night', 'Cover per laptop con stampa Starry Night di Vincent van Gogh', 17.99, 80, 'Plastica rigida', 'productImages/gadgets/cover laptop starry night.jpg', 0, 0, 0),
('Orologio da parete creativo', 'Orologio da parete con design creativo e moderno', 21.99, 70, 'Plastica', 'productImages/gadgets/orologio da parete.jpg', 30.0, 30.0, 0);

...
CREATE TABLE datiFatturazione (
	Ordine INT UNSIGNED PRIMARY KEY,
	Nome VARCHAR(50),
    Cognome VARCHAR(50),
    Città VARCHAR(50),
    Via VARCHAR(50),
...
CREATE TABLE recensioneLibro(
ID INT AUTO_INCREMENT PRIMARY KEY ,
Cliente VARCHAR(50) NOT NULL,
Libro INT NOT NULL,
Descrizione VARCHAR(1000),
Valutazione INT UNSIGNED NOT NULL CHECK (Valutazione BETWEEN 1 AND 5),
...
FOREIGN KEY (Libro)
	REFERENCES libro (ID)
    ON UPDATE CASCADE ON DELETE CASCADE,
    UNIQUE(Cliente, Libro) 
);

CREATE TABLE recensioneMusica(
ID INT AUTO_INCREMENT PRIMARY KEY,
Cliente VARCHAR(50) NOT NULL,
Musica INT NOT NULL,
Descrizione VARCHAR(1000),
...
FOREIGN KEY (Musica)
	REFERENCES musica (ID)
    ON UPDATE CASCADE ON DELETE CASCADE,
    UNIQUE(Cliente, Musica) 
);

CREATE TABLE recensioneGadget(
ID INT AUTO_INCREMENT PRIMARY KEY,
Cliente VARCHAR(50) NOT NULL,
Gadget INT NOT NULL,
Descrizione VARCHAR(1000),
